...
public class DatabaseConfig {
    ...
    private DataSource getDatasource(){
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/privateschool?serverTimezone=Europe/Athens");
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("noslia.entity");
